...
uimenu( plotmenu, 'label', 'View extended channel properties', ...
    'callback', [try_strings.no_check '[temp1, temp2, LASTCOM] = pop_viewprops(EEG, 1);' catch_strings.add_to_hist]);
uimenu( plotmenu, 'label', 'View extended component properties', ...
    'callback', [try_strings.no_check '[temp1, temp2, LASTCOM] = pop_viewprops(EEG, 0);' catch_strings.add_to_hist]);
end
